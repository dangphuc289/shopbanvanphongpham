        ...
        <div class="menu">
            ...
            <div class="menu-list">
                <ul class="list">
                    ...
                    <li class="item"><a href="">Thể Loại</a></li>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if(isset($_GET['search'])){
                        $search = $_GET['search'];
                        $querySearch = "SELECT * from theloai where '$search' is not null and tenTL like CONCAT ('%$search%') or '$search' is null  ";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="link">
                                <a style="text-decoration: none;" href="index.php?page_layout=sua&id=<?php echo $row['maTL']; ?>">Sửa</a>
                            </td>
                            <td class="link">
                                <a style="text-decoration: none;" onclick="return Del('<?php echo $row['tenTL'] ?>')" href="index.php?page_layout=xoa&id=<?php echo $row['maTL']; ?>">Xóa</a>
                            </td>
