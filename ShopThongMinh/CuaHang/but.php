...
<?php
    ...
    $sql = "SELECT * FROM sanpham inner join nhasanxuat on sanpham.maNSX = nhasanxuat.maNSX WHERE maTL = 2 ";
    ...
    <div class="main-product">
        <div class="category">
            ...
            <ul class="category-list">
                ...
                <li class="category-item"><a href="">Bút</a></li>
                <li class="category-item"><a href="./tapso.php">Tập Sổ</a></li>
        ...
        <div class="footer-center">
            ...
            <div class="center-menu">
                ...
                <ul class="menu-center">
                    ...
                    <li class="menu-center-list"><a href="">Giới thiệu</a></li>
                    <li class="menu-center-list"><a href="">Cửa hàng</a></li>
                    <li class="menu-center-list"><a href="">Liên hệ</a></li>
                </ul>
            </div>
            <div class="center-menu">
                <h4>DANH MỤC SẢN PHẨM</h4>
                <ul class="menu-center">
                    <li class="menu-center-list"><a href="">Dụng cụ văn phòng</a></li>
                    <li class="menu-center-list"><a href="">Bút</a></li>
                    <li class="menu-center-list"><a href="">Giấy</a></li>
                    <li class="menu-center-list"><a href="">Thiết bị</a></li>
